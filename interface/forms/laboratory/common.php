...
use mdts\objects\LabOrder;
use mdts\objects\LabOrderItem;
use mdts\objects\LabResult;
use mdts\objects\LabResultItem;
...
try {
	...
	if ($order_data && $order_data->id) {
		...
		$date_ordered = FormatDate($order_data->date_ordered);
	...
	$label_list = new Options('Lab_'.$lab_type.'_Printers');

	// find subaccount
	$key = $enc_data->facility_id;
	$acct_id = $acct_list->getItem($key);
	if (!$acct_id || $acct_id == '* Not Found *') {
	...
	if (!file_exists($GLOBALS["srcdir"]."/mdts")) $invalid .= "Missing MDTS Library\n";
	if (!file_exists($GLOBALS["vendor_dir"]."/tecnickcom")) $invalid .= "Missing TCPDF Library\n";
...
?>
		...
		<br/><br/>
		<a href="http://www.williamsmedtech.com/support" target="_blank"><b>Laboratory Order</b></a>
		<br/><br/>
...
<?php
	...
	mdts\LogError(E_ERROR, $e->getMessage());
	die("FATAL ERROR");
}
...
<?php } ?>
		...
		function addTestRow(code,type,text) {
			...
			var current = $('#transport_name').val();
...
<?php } ?>
									<div class="form-inline pb-1" >
										...
										<input class="form-control form-control-sm w-auto" type='date' name='date_collected' id='date_collected' 
											value='<?php echo FormatDate($order_data->date_collected); ?>' />
										...
										<input class="form-control form-control-sm w-auto" type='time' name='time_collected' id='time_collected' 
											value='<?php echo FormatTime($order_data->date_collected); ?>' />
									</div>
								</div>
								...
								<div id="psc_data" style="<?php if (!$order_data->order_psc && !$GLOBALS['wmt_lab_psc']) echo "display:none" ?>">
									<div class="form-inline pb-1">
										...
										<input class="form-control form-control-sm w-auto" type='date' name='date_pending' id='date_pending' 
											value='<?php echo FormatDate($order_data->date_pending); ?>' />
									</div>
								</div>
							...
							<div class="form-row m-0">
								...
								<div class="col-6 pl-2 pt-3">
									<div class="form-inline flex-nowrap pb-1">
										<div class="control-label text-nowrap w-25">Ordering Provider:</div>
									...
									<div class="form-inline flex-nowrap pb-1">
										<div class="control-label text-nowrap w-25">Order Date:</div>
										<input class="form-control form-control-sm w-25" type='date' name='date_ordered' id='date_ordered'
												value='<?php echo FormatDate($order_data->date_ordered) ?>' />
										<div class="control-label text-nowrap pl-2 w-25">Billing Type:</div>
										<select class="form-control form-control-sm" autocomplete="off" name='billing_type' id='billing_type' autocomplete="off">
...
?>
									...
									<div class="form-inline flex-nowrap pb-1">
										<div class="control-label text-nowrap w-25">Process Date:</div>
										<input class="form-control form-control-sm w-25" type='date' name='date_transmitted' id='date_transmitted' readonly
											value='<?php echo FormatDate($order_data->date_transmitted) ?>' />
										<div class="control-label text-nowrap pl-2 w-25">Order Status:</div>
										<input class="form-control form-control-sm w-25" type='text' id='order_status' readonly
...
?>
								<div class="form-inline pb-1" >
									...
									<input class="form-control form-control-sm w-auto" type='date' readonly value='<?php echo FormatDate($order_data->date_transmitted); ?>' />
									<div class="control-label pl-4 pr-2 text-right" style="width:100px">Time: </div>
									<input class="form-control form-control-sm w-auto" type='time' readonly value='<?php echo FormatTime($order_data->date_transmitted); ?>' />
								</div>
								<div class="form-inline pb-1" >
									<div class="control-label pr-2" style="width:130px">Collection Date: </div>
									<input class="form-control form-control-sm w-auto" type='date' readonly value='<?php echo FormatDate($order_data->date_collected); ?>' />
									<div class="control-label pl-4 pr-2 text-right" style="width:100px">Time: </div>
									<input class="form-control form-control-sm w-auto" type='time' readonly value='<?php echo FormatTime($order_data->date_collected); ?>' />
								</div>
								<div class="form-inline pb-1" >
									<div class="control-label pr-2" style="width:130px">Reported Date: </div>
									<input class="form-control form-control-sm w-auto" type='date' readonly value='<?php echo FormatDate($order_data->report_datetime); ?>' />
									<div class="control-label pl-4 pr-2 text-right" style="width:100px">Time: </div>
									<input class="form-control form-control-sm w-auto" type='time' readonly value='<?php echo FormatTime($order_data->report_datetime); ?>' />
								...
								<div class="col-6 pl-2">
									<div class="form-inline pb-1">
										...
										<input class="form-control form-control-sm w-auto" type='date' name='resulted_date' id='date_resulted' readonly
												value='<?php echo FormatDate($order_data->received_datetime) ?>' />
									</div>
									<div class="form-inline pb-1">
...
<?php } ?>
									...
									<div class="form-inline pb-1">
										...
										<input class="form-control form-control-sm w-auto" type='date' name='reviewed_date' id='date_reviewed'
											value='<?php echo FormatDate($order_data->reviewed_datetime) ?>' />
									</div>
...
<?php } ?>
									...
									<div class="form-inline pb-1">
										...
										<input class="form-control form-control-sm w-auto" type='date' name='notified_date' id='date_notified'
											value='<?php FormatDate($order_data->notified_datetime) ?>' />
									</div>
									<div class="form-inline pb-1">
