 ...
 *
 *	Copyright (c)2022 - Medical Techology Services
 *
				...
				foreach ($sColumns AS $column) {
					...
					switch ($column['name']) {
						case 'patient':
							...
							break;
						case 'pat_DOB':
							$element = FormatDate($record['pat_DOB']);
							break;
						case 'pat_sex':
							$element = 'UNKNOWN';
						...
						case 'provider':
							...
							break;
						case 'ordered':
							$element = FormatDate($record['date_ordered']);
							break;
						case 'reported':
							$element = FormatDate($record['report_datetime']);
							break;
						case 'active':
