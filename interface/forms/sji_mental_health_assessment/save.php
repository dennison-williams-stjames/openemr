 ...
 */
$table_name = "form_sji_mental_health_assessment";
...
foreach ($mental_health_assessment_columns as $column) {
...
if ($_GET["mode"] == "new") {
    ...
    addForm($encounter, "Mental health assessment", $newid, $form_name, $pid, $userauthorized);
