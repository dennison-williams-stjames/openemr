 ...
 */
$table_name = "form_sji_mental_health_treatment_plan";
...
foreach ($mental_health_treatment_plan_columns as $column) {
...
if ($_GET["mode"] == "new") {
    ...
    addForm($encounter, "Mental health treatment plan", $newid, $form_name, $pid, $userauthorized);
