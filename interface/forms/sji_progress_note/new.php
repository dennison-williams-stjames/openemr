...
<div class="col-sm-12">
<span class="title"><?php echo xlt('Progress Note'); ?></span>
</div> <!-- col-sm-12 -->
</div> <!-- roww bg-primary -->
...
<div class="col-sm-4">
<select id="treatment_location" name="treatment_location" class="select2 form-control" <?php
...
<div class="col-sm-4">
<select id="service_type" name="service_type" class="select2 form-control" <?php
...
<div class="col-sm-4">
<select id="sji_progress_notes_duration" name="sji_progress_notes_duration" class="select2 form-control" data-placeholder="Select or enter the time spent...">
<option></option>
...
<!-- active -->
<div class="form-group row">
<label for="inactive" class="control-label col-sm-5"><?php 
   echo xlt('Participant is no longer active in the mental health program');
?>:</label>
<div class="col-sm-1">
<input type="checkbox" id="inactive" name="inactive" <?php 
if ( !empty($obj['inactive']) && $obj['inactive'] > 0 ) { 
   echo "checked"; 
} 
?>>
</div>
