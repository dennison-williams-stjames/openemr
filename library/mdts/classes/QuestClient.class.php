...
require_once($GLOBALS['srcdir'].'/mdts/quest/OrderService.php');
...
class QuestClient {
	...
	public function __construct($lab_id) {
		...
		if ($lab_data->DorP) $this->STATUS = $lab_data->DorP; // production
		...
		$this->ENDPOINT = $lab_data->remote_host . $lab_data->orders_path;
