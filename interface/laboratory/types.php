...
<head>
    ...
    <title><?php echo xlt('Laboratory Tests and Results'); ?></title>
...
<body>
    ...
    <div class="container mt-3">
        <div class="row">
             <div class="col-sm-12">
                <h2 id="header_title"><span id='header_text'><?php echo xlt('Laboratory Tests and Results');?></span><?php echo $help_icon; ?></h2>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                        ...
                        <table class="table mb-0">
                            <thead>
                                <tr class='head'>
                                    ...
                                    <td class='col2 text-left'><?php echo xlt('Category') ?> <i id="order-tooltip" class="fa fa-info-circle oe-text-black" aria-hidden="true"></i></td>
                                    <td class='col3 text-left'><?php echo xlt('Code') ?> <i id="code-tooltip" class="fa fa-info-circle oe-text-black" aria-hidden="true"></i></td>
                                    <td class='col6 text-left'><?php echo xlt('Tier') ?> <i id="tier-tooltip" class="fa fa-info-circle oe-text-black" aria-hidden="true"></i></td>
                                    <td class='col4 text-left'><?php echo xlt('Description') ?></td>
                                    <td class='col5 text-left'><?php echo xlt('Edit') ?></td>
                                    <td class='col5 text-center'><?php echo xlt('Add') ?></td>
                                </tr>
                            </thead>
                        </table>
                    </div>
